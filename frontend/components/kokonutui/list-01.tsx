...
const ACCOUNTS: AccountItem[] = [
  { id: "1", title: "Main Savings", description: "Personal savings", balance: "$8,459.45", type: "savings" },
  { id: "2", title: "Checking Account", description: "Daily expenses", balance: "$2,850.00", type: "checking" },
  { id: "3", title: "Investment Portfolio", description: "Stock & ETFs", balance: "$15,230.80", type: "investment" },
  { id: "4", title: "Credit Card", description: "Pending charges", balance: "$1,200.00", type: "debt" },
  { id: "5", title: "Savings Account", description: "Emergency fund", balance: "$3,000.00", type: "savings" },
]
          ...
          {accounts.map((account) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                >
                  {account.type === "savings" && <Wallet className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />}
                  {account.type === "checking" && <QrCode className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" />}
                  {account.type === "investment" && <ArrowUpRight className="w-3.5 h-3.5 text-purple-600 dark:text-purple-400" />}
