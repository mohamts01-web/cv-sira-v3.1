...
const TRANSACTIONS: Transaction[] = [
  { id: "1", title: "Apple Store Purchase", amount: "$999.00", type: "outgoing", icon: ShoppingCart, timestamp: "Today, 2:45 PM", status: "completed" },
  { id: "2", title: "Salary Deposit", amount: "$4,500.00", type: "incoming", icon: Wallet, timestamp: "Today, 9:00 AM", status: "completed" },
  { id: "3", title: "Netflix Subscription", amount: "$15.99", type: "outgoing", icon: CreditCard, timestamp: "Yesterday", status: "pending" },
  { id: "4", title: "Apple Store Purchase", amount: "$999.00", type: "outgoing", icon: ShoppingCart, timestamp: "Today, 2:45 PM", status: "completed" },
  { id: "5", title: "Supabase Subscription", amount: "$25.00", type: "outgoing", icon: CreditCard, timestamp: "Yesterday", status: "pending" },
  { id: "6", title: "Vercel Subscription", amount: "$20.00", type: "outgoing", icon: CreditCard, timestamp: "Yesterday", status: "pending" },
]
              ...
              <div className="flex-1 flex items-center justify-between min-w-0">
                ...
                <div className="flex items-center gap-1.5 pl-3">
                  <span
                    className={cn(
                      "text-xs font-medium",
                      transaction.type === "incoming" ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400",
                    )}
                  >
      ...
      <div className="p-2 border-t border-zinc-100 dark:border-zinc-800">
        <button
          ...
          className={cn(
            ...
            "text-xs font-medium",
            "bg-gradient-to-r from-zinc-900 to-zinc-800 dark:from-zinc-50 dark:to-zinc-200",
            "text-zinc-50 dark:text-zinc-900",
            "hover:from-zinc-800 hover:to-zinc-700 dark:hover:from-zinc-200 dark:hover:to-zinc-300",
            "shadow-sm hover:shadow transform transition-all duration-200 hover:-translate-y-0.5",
          )}
        >
