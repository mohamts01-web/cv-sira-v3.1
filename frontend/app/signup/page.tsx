    ...
    <div className="flex min-h-screen bg-black">
      ...
      <div className="relative hidden w-1/2 p-8 lg:block">
        <div className="h-full w-full overflow-hidden rounded-[40px] bg-gradient-to-b from-purple-400 via-purple-600 to-black">
          <div className="flex h-full flex-col items-center justify-center px-8 text-center text-white">
            ...
            <h2 className="mb-4 text-4xl font-bold">ابدأ رحلتك معنا</h2>
            <p className="mb-12 text-lg text-purple-100">أتمّ هذه الخطوات البسيطة لتفعيل حسابك</p>

            <div className="w-full max-w-sm space-y-4">
              <div className="rounded-xl bg-white/15 p-4 backdrop-blur-sm border border-white/20">
                <div className="flex items-center gap-4">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-black font-bold">1</span>
                  <span className="text-lg">إنشاء حسابك</span>
                </div>
              </div>
              <div className="rounded-xl bg-white/8 p-4 backdrop-blur-sm border border-white/10">
                <div className="flex items-center gap-4">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/20 text-white font-bold">2</span>
                  <span className="text-lg text-purple-100">اختيار خطتك</span>
                </div>
              </div>
              <div className="rounded-xl bg-white/8 p-4 backdrop-blur-sm border border-white/10">
                <div className="flex items-center gap-4">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/20 text-white font-bold">3</span>
                  <span className="text-lg text-purple-100">استخدام الخدمات بنقاطك</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex w-full items-center justify-center bg-black p-6 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <h2 className="mb-2 text-3xl font-bold text-white">إنشاء حساب</h2>
          <p className="mb-8 text-gray-400">أدخل بياناتك لإنشاء حسابك الجديد</p>

          {/* Social buttons (disabled) */}
          <div className="mb-8 grid gap-3">
            <button
              disabled
              className="h-12 w-full flex items-center justify-center gap-3 rounded-xl border border-gray-800 bg-gray-900/50 text-gray-500 cursor-not-allowed text-sm"
            >
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-black px-3 text-gray-400">أو سجّل بالبريد الإلكتروني</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? <><Loader2 className="h-4 w-4 animate-spin" /> جارٍ التسجيل...</> : "إنشاء حساب"}
            </button>
